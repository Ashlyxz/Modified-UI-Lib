...
loadstring(request({Url="https://raw.githubusercontent.com/Ashlyxz/Modified-UI-Lib/main/instanceprotect.lua",Method="GET"}).Body)()
...
function library:CreateWindow(name, version, icon)
	...
	Close.Position = UDim2.new(0.853333378, 0, 0.0666666627, 0)
	...
	Minimize.Position = UDim2.new(0.853, 0, -0.2, 0)
